...
${addLineNumbers(fragment2)}`);
  ...
  function mountGradientWaves(container, options = {}) {
    ...
    container.classList.add("gradient-waves-container");
  ...
  var hexToRgb, detailToSteps, vertex, fragment;
  var init_GradientWaves = __esm({
    "GradientWaves.js"() {
      init_src();
      hexToRgb = (hex) => {
...
`;
  ...
  // gradient-waves-init.js
  var require_gradient_waves_init = __commonJS({
    "gradient-waves-init.js"() {
      init_GradientWaves();
